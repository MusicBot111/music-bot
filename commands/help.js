  ...
  run: async (client, interaction) => {
    try {
      const musicCommandsEmbed = new EmbedBuilder()
        ...
        .setImage(`https://cdn.discordapp.com/attachments/1004341381784944703/1165201249331855380/RainbowLine.gif?ex=6611043a&is=65fe8f3a&hm=8f6eb16a2001c85c115ea633886bede9494b9a8c46103a72cf54d9303432fe8f&`); 
      ...
      const basicCommandsEmbed = new EmbedBuilder()
       ...
       .setImage('https://media.tenor.com/T81rp0OHXMwAAAAd/sana-twice.gif')
      const button1 = new ButtonBuilder()
        .setLabel('YouTube')
        .setURL('https://www.youtube.com/@PaoLUL_')
        .setStyle(ButtonStyle.Link);

      const button2 = new ButtonBuilder()
        .setLabel('Discord')
        .setURL('https://discord.gg/gmmfcDFbqw')
        .setStyle(ButtonStyle.Link);
